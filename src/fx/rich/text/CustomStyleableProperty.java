...
public class CustomStyleableProperty<T> extends StyleableObjectProperty<T> {
  ...
  final Object bean;
  final String name;
  final CssMetaData<? extends Styleable, T> cssMetaData;

  public CustomStyleableProperty(T initialValue, String name, Object bean, CssMetaData<? extends Styleable, T> cssMetaData) {
    super(initialValue);
    this.bean = bean;
    this.name = name;
