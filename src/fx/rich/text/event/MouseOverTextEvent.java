...
public abstract class MouseOverTextEvent extends Event {
  ...
  static final End DEFAULT_END = new End(null, null);
  ...
  static class Begin extends MouseOverTextEvent {
    Begin(Object source, EventTarget target, Point2D screenPos, int charIdx) {
    ...
    @Override public Point2D getScreenPosition() { return screenPos; }
    @Override public int getCharacterIndex() { return charIdx; }
    ...
    public Point2D getScenePosition() {
      ...
      return screenPos.subtract(scene.getX() + scene.getWindow().getX(), scene.getY() + scene.getWindow().getY());
    }
  ...
  static class End extends MouseOverTextEvent {
    End(Object source, EventTarget target) {
      super(source, target, MOUSE_OVER_TEXT_END);
    }

    @Override public int getCharacterIndex() { return -1; }
    @Override public Point2D getPosition() { return null; }
    @Override public Point2D getScenePosition() { return null; }
    @Override public Point2D getScreenPosition() { return null; }

    @Override public End copyFor(Object newSource, EventTarget newTarget) {
  ...
  MouseOverTextEvent(Object source, EventTarget target, EventType<? extends MouseOverTextEvent> type) {
