...
public class CustomCssMetaData<S extends Styleable, V> extends CssMetaData<S, V> {
  ...
  final Function<S, StyleableObjectProperty<V>> property;

  CustomCssMetaData(String property, StyleConverter<?, V> converter, V initialValue, Function<S, StyleableObjectProperty<V>> getStyleableProperty) {
