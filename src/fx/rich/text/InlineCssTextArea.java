...
import static fx.rich.text.model.Codec.styledTextCodec;
...
public class InlineCssTextArea extends StyledTextArea<String, String> {
   ...
   */
  public InlineCssTextArea(
    @NamedArg("document") EditableStyledDocument<String, String, String> document
  ) {
    super("", TextFlow::setStyle, "", TextExt::setStyle, document, true);
  ...
  public InlineCssTextArea(@NamedArg("text") String text) {
    ...
    replace(0, 0, ReadOnlyStyledDocument
      .fromString(text, getInitialParagraphStyle(), getInitialTextStyle(), getSegOps())
    );
