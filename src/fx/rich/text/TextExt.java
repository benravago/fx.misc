...
public class TextExt extends Text {
  ...
  /*<init>*/ static {
    ...
    var styleables = new ArrayList<CssMetaData<? extends Styleable, ?>>(Text.getClassCssMetaData());
  ...
  final StyleableObjectProperty<Paint> backgroundColor = new CustomStyleableProperty<>(
    null, "backgroundColor",this, StyleableProperties.BACKGROUND_COLOR);

  final StyleableObjectProperty<Paint> borderStrokeColor = new CustomStyleableProperty<>(
    null, "borderStrokeColor", this, StyleableProperties.BORDER_COLOR);

  final StyleableObjectProperty<Number> borderStrokeWidth = new CustomStyleableProperty<>(
    null, "borderStrokeWidth", this, StyleableProperties.BORDER_WIDTH);

  final StyleableObjectProperty<StrokeType> borderStrokeType = new CustomStyleableProperty<>(
    null, "borderStrokeType", this, StyleableProperties.BORDER_TYPE);

  final StyleableObjectProperty<Number[]> borderStrokeDashArray = new CustomStyleableProperty<>(
    null, "borderStrokeDashArray", this, StyleableProperties.BORDER_DASH_ARRAY);

  final StyleableObjectProperty<Paint> underlineColor = new CustomStyleableProperty<>(
    null, "underlineColor", this, StyleableProperties.UNDERLINE_COLOR);

  final StyleableObjectProperty<Number> underlineWidth = new CustomStyleableProperty<>(
    null, "underlineWidth", this, StyleableProperties.UNDERLINE_WIDTH);

  final StyleableObjectProperty<Number[]> underlineDashArray = new CustomStyleableProperty<>(
    null, "underlineDashArray", this, StyleableProperties.UNDERLINE_DASH_ARRAY);

  final StyleableObjectProperty<StrokeLineCap> underlineCap = new CustomStyleableProperty<>(
  ...
  public StrokeType getBorderStrokeType() {
    return borderStrokeType.get();
  }

  public void setBorderStrokeType(StrokeType type) {
    borderStrokeType.set(type);
  }
  ...
  public Number[] getBorderStrokeDashArray() {
    return borderStrokeDashArray.get();
  }

  public void setBorderStrokeDashArray(Number[] array) {
    borderStrokeDashArray.set(array);
  }
  ...
  public Number[] getUnderlineDashArray() {
    return underlineDashArray.get();
  }

  public void setUnderlineDashArray(Number[] dashArray) {
    underlineDashArray.set(dashArray);
  }
  ...
  static class StyleableProperties {
    ...
    static final CssMetaData<TextExt, Paint> BACKGROUND_COLOR = new CustomCssMetaData<>(
      "-rtfx-background-color", StyleConverter.getPaintConverter(), Color.TRANSPARENT, n -> n.backgroundColor);

    static final CssMetaData<TextExt, Paint> BORDER_COLOR = new CustomCssMetaData<>(
      "-rtfx-border-stroke-color", StyleConverter.getPaintConverter(), Color.TRANSPARENT, n -> n.borderStrokeColor);

    static final CssMetaData<TextExt, Number> BORDER_WIDTH = new CustomCssMetaData<>(
      "-rtfx-border-stroke-width", StyleConverter.getSizeConverter(), 0, n -> n.borderStrokeWidth);

    static final CssMetaData<TextExt, StrokeType> BORDER_TYPE = new CustomCssMetaData<>(
      "-rtfx-border-stroke-type", (StyleConverter<?, StrokeType>) StyleConverter.getEnumConverter(StrokeType.class), StrokeType.INSIDE, n -> n.borderStrokeType);

    static final CssMetaData<TextExt, Number[]> BORDER_DASH_ARRAY = new CustomCssMetaData<>(
      "-rtfx-border-stroke-dash-array", SizeConverter.SequenceConverter.getInstance(), new Double[0], n -> n.borderStrokeDashArray);

    static final CssMetaData<TextExt, Paint> UNDERLINE_COLOR = new CustomCssMetaData<>(
      "-rtfx-underline-color", StyleConverter.getPaintConverter(), Color.TRANSPARENT, n -> n.underlineColor);

    static final CssMetaData<TextExt, Number> UNDERLINE_WIDTH = new CustomCssMetaData<>(
      "-rtfx-underline-width", StyleConverter.getSizeConverter(), 0, n -> n.underlineWidth);

    static final CssMetaData<TextExt, Number[]> UNDERLINE_DASH_ARRAY = new CustomCssMetaData<>(
      "-rtfx-underline-dash-array", SizeConverter.SequenceConverter.getInstance(), new Double[0], n -> n.underlineDashArray);

    static final CssMetaData<TextExt, StrokeLineCap> UNDERLINE_CAP = new CustomCssMetaData<>(
      "-rtfx-underline-cap", (StyleConverter<?, StrokeLineCap>) StyleConverter.getEnumConverter(StrokeLineCap.class), StrokeLineCap.SQUARE, n -> n.underlineCap);
  }
