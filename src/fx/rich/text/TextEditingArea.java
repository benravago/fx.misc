...
public interface TextEditingArea<PS, SEG, S> {
  ...
  default int getParagraphLength(int index) {
    return getParagraph(index).length();
  }
  ...
  /**
   * See {@link fx.rich.text.model.EditableStyledDocument#multiPlainChanges()}
   */
  EventStream<List<PlainTextChange>> multiPlainChanges();

  /**
   * See {@link fx.rich.text.model.EditableStyledDocument#plainChanges()}
   */
  EventStream<PlainTextChange> plainTextChanges();

  /**
   * See {@link fx.rich.text.model.EditableStyledDocument#multiRichChanges()}
   */
  EventStream<List<RichTextChange<PS, SEG, S>>> multiRichChanges();

  /**
   * See {@link fx.rich.text.model.EditableStyledDocument#richChanges()}
   */
  ...
  default String getText(int startParagraph, int startColumn, int endParagraph, int endColumn) {
    var start = getAbsolutePosition(startParagraph, startColumn);
    var end = getAbsolutePosition(endParagraph, endColumn);
  ...
  default void selectRange(int anchorParagraph, int anchorColumn, int caretPositionParagraph, int caretPositionColumn) {
    var anchor = getAbsolutePosition(anchorParagraph, anchorColumn);
    var caretPosition = getAbsolutePosition(caretPositionParagraph, caretPositionColumn);
