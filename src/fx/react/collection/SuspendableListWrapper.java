...
class SuspendableListWrapper<E> extends SuspendableBase<Observer<? super E, ?>, QuasiChange<? extends E>, ListModificationSequence<E>> implements SuspendableList<E>, ProperLiveList<E> {

  final ObservableList<E> delegate;
  ...
  @Override
  protected QuasiChange<? extends E> headOf(ListModificationSequence<E> accum) {
