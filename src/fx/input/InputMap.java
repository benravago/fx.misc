 ...
 * {@link fx.input.template.InputMapTemplate} to create an {@link InputMap} for each
...
public interface InputMap<E extends Event> {
   ...
   */
  static <T extends Event, U extends T> InputMap<U> process(EventPattern<? super T, ? extends U> eventPattern, Function<? super U, InputHandler.Result> action) {
   ...
   * to pattern match the event type with the next {@code InputMap} (if one exists).
   */
  static <T extends Event> InputMap<T> process(EventType<? extends T> eventType, Function<? super T, InputHandler.Result> action) {
   ...
   */
  static <T extends Event, U extends T> InputMap<U> consume(EventPattern<? super T, ? extends U> eventPattern, Consumer<? super U> action) {
   ...
   * and does not attempt to match additional {@code InputMap}s (if they exist).
   */
  static <T extends Event> InputMap<T> consume(EventType<? extends T> eventType, Consumer<? super T> action) {
   ...
   * {@code InputMap}s (if they exist).
   */
  static <T extends Event, U extends T> InputMap<U> consumeWhen(EventPattern<? super T, ? extends U> eventPattern, BooleanSupplier condition, Consumer<? super U> action) {
    return process(eventPattern, u -> {
   ...
   * {@code InputMap}s (if they exist).
   */
  static <T extends Event> InputMap<T> consumeWhen(EventType<? extends T> eventType, BooleanSupplier condition, Consumer<? super T> action) {
   ...
   */
  static <T extends Event, U extends T> InputMap<U> consumeUnless(EventPattern<? super T, ? extends U> eventPattern, BooleanSupplier condition, Consumer<? super U> action) {
   ...
   * the event type with the next {@code InputMap} (if one exists).
   */
  static <T extends Event> InputMap<T> consumeUnless(EventType<? extends T> eventType, BooleanSupplier condition, Consumer<? super T> action) {
   ...
   */
  static <T extends Event> InputMap<T> when(BooleanSupplier condition, InputMap<T> im) {
    return new InputMap<T>() {
      @Override
      public void forEachEventType(HandlerConsumer<? super T> f) {
        var g = new HandlerConsumer<T>() {
          @Override
   ...
   * proceeds to the next {@code InputMap} (if it exists).
   */
  static <T extends Event> InputMap<T> unless(BooleanSupplier condition, InputMap<T> im) {
