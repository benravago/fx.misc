...
import fx.undo.manager.ChangeQueue;
import fx.undo.manager.FixedSizeChangeQueue;
import fx.undo.manager.MultiChangeUndo;
import fx.undo.manager.SingleChangeUndo;
import fx.undo.manager.UnlimitedChangeQueue;
import fx.undo.manager.ZeroSizeChangeQueue;
...
public interface UndoManagerFactory {
   ...
   */
  default <C> UndoManager<C> createSingleChangeUM(EventStream<C> changeStream, Function<? super C, ? extends C> invert, Consumer<C> apply) {
   ...
   */
  default <C> UndoManager<C> createSingleChangeUM(EventStream<C> changeStream, Function<? super C, ? extends C> invert, Consumer<C> apply, BiFunction<C, C, Optional<C>> merge) {
   ...
   */
  default <C> UndoManager<C> createSingleChangeUM(EventStream<C> changeStream, Function<? super C, ? extends C> invert, Consumer<C> apply, BiFunction<C, C, Optional<C>> merge, Predicate<C> isIdentity) {
   ...
   */
  <C> UndoManager<C> createSingleChangeUM(EventStream<C> changeStream, Function<? super C, ? extends C> invert,
      Consumer<C> apply, BiFunction<C, C, Optional<C>> merge, Predicate<C> isIdentity, Duration preventMergeDelay);
   ...
   */
  public static <C> UndoManager<C> unlimitedHistorySingleChange(EventStream<C> changeStream, Function<? super C, ? extends C> invert, Consumer<C> apply) {
    return unlimitedHistorySingleChange(changeStream, invert, apply, (c1, c2) -> Optional.empty());
  }
   ...
   * {@link #createSingleChangeUM(EventStream, Function, Consumer, BiFunction, Predicate, Duration)}.
   */
  public static <C> UndoManager<C> unlimitedHistorySingleChange(EventStream<C> changeStream, Function<? super C, ? extends C> invert, Consumer<C> apply, BiFunction<C, C, Optional<C>> merge) {
   ...
   * {@link #createSingleChangeUM(EventStream, Function, Consumer, BiFunction, Predicate, Duration)}.
   */
  public static <C> UndoManager<C> unlimitedHistorySingleChange(EventStream<C> changeStream, Function<? super C, ? extends C> invert, Consumer<C> apply, BiFunction<C, C, Optional<C>> merge, Predicate<C> isIdentity) {
  ...
  public static <C> UndoManager<C> unlimitedHistorySingleChangeUM(EventStream<C> changeStream, Function<? super C, ? extends C> invert, Consumer<C> apply, BiFunction<C, C, Optional<C>> merge, Predicate<C> isIdentity, Duration preventMergeDelay) {
    var queue = new UnlimitedChangeQueue<C>();
    return new SingleChangeUndo<>(queue, invert, apply, merge, isIdentity, changeStream, preventMergeDelay);
  }
   ...
   */
  public static <C> UndoManager<C> fixedSizeHistorySingleChange(EventStream<C> changeStream, Function<? super C, ? extends C> invert, Consumer<C> apply, int capacity) {
  ...
  public static <C> UndoManager<C> fixedSizeHistorySingleChangeUM(EventStream<C> changeStream, Function<? super C, ? extends C> invert, Consumer<C> apply, BiFunction<C, C, Optional<C>> merge, Predicate<C> isIdentity, Duration preventMergeDelay, int capacity) {
    var queue = new FixedSizeChangeQueue<C>(capacity);
    return new SingleChangeUndo<>(queue, invert, apply, merge, isIdentity, changeStream, preventMergeDelay);
  }
   ...
   */
  public static <C> UndoManager<C> zeroHistorySingleChange(EventStream<C> changeStream) {
    var queue = new ZeroSizeChangeQueue<C>();
    return new SingleChangeUndo<>(queue, c -> c, c -> {}, (c1, c2) -> Optional.empty(), c -> false, changeStream);
  }
   ...
   */
  default <C> UndoManager<List<C>> createMultiChangeUM(EventStream<List<C>> changeStream, Function<? super C, ? extends C> invert, Consumer<List<C>> apply) {
   ...
   *              Returns an empty {@linkplain Optional} when the changes cannot or should not be merged.
   */
  default <C> UndoManager<List<C>> createMultiChangeUM(EventStream<List<C>> changeStream, Function<? super C, ? extends C> invert, Consumer<List<C>> apply, BiFunction<C, C, Optional<C>> merge) {
   ...
   *                   to an identity function ({@link Function#identity()}) on the underlying model.
   */
  default <C> UndoManager<List<C>> createMultiChangeUM(EventStream<List<C>> changeStream, Function<? super C, ? extends C> invert, Consumer<List<C>> apply, BiFunction<C, C, Optional<C>> merge, Predicate<C> isIdentity) {
   ...
   *                          a negative or zero duration will never call {@link UndoManager#preventMerge()}.
   */
  <C> UndoManager<List<C>> createMultiChangeUM(EventStream<List<C>> changeStream, Function<? super C, ? extends C> invert, Consumer<List<C>> apply, BiFunction<C, C, Optional<C>> merge, Predicate<C> isIdentity, Duration preventMergeDelay);
   ...
   */
  public static <C> UndoManager<List<C>> unlimitedHistoryMultiChange(EventStream<List<C>> changeStream, Function<? super C, ? extends C> invert, Consumer<List<C>> apply) {
   ...
   * {@link #createMultiChangeUM(EventStream, Function, Consumer, BiFunction, Predicate, Duration)}.
   */
  public static <C> UndoManager<List<C>> unlimitedHistoryMultiChange(EventStream<List<C>> changeStream, Function<? super C, ? extends C> invert, Consumer<List<C>> apply, BiFunction<C, C, Optional<C>> merge, Predicate<C> isIdentity) {
  ...
  public static <C> UndoManager<List<C>> unlimitedHistoryMultiChangeUM(EventStream<List<C>> changeStream, Function<? super C, ? extends C> invert, Consumer<List<C>> apply, BiFunction<C, C, Optional<C>> merge, Predicate<C> isIdentity, Duration preventMergeDelay) {
    ...
    return new MultiChangeUndo<>(queue, invert, apply, merge, isIdentity, changeStream, preventMergeDelay);
  }
  ...
  public static <C> UndoManager<List<C>> zeroHistoryMultiChangeUM(EventStream<List<C>> changeStream) {
    ...
    return new MultiChangeUndo<>(queue, c -> c, doNothingForUndoAndRedo, (c1, c2) -> Optional.empty(), c -> false, changeStream);
  }
   ...
   *
   * @see #zeroHistorySingleChange(EventStream)
  ...
  public static UndoManagerFactory zeroHistoryFactory() {
    return new UndoManagerFactory() {
      @Override
      public <C> UndoManager<C> createSingleChangeUM(EventStream<C> changeStream, Function<? super C, ? extends C> invert, Consumer<C> apply, BiFunction<C, C, Optional<C>> merge, Predicate<C> isIdentity, Duration preventMergeDelay) {
        return zeroHistorySingleChange(changeStream);
      }
      @Override
      public <C> UndoManager<List<C>> createMultiChangeUM(EventStream<List<C>> changeStream, Function<? super C, ? extends C> invert, Consumer<List<C>> apply, BiFunction<C, C, Optional<C>> merge, Predicate<C> isIdentity, Duration preventMergeDelay) {
